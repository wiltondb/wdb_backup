...
#[derive(Default)]
pub(super) struct CommandDialogLayout {
    root_layout: nwg::FlexboxLayout,
    buttons_layout: nwg::FlexboxLayout,
}

impl ui::Layout<CommandDialogControls> for CommandDialogLayout {
    fn build(&self, c: &CommandDialogControls) -> Result<(), nwg::NwgError> {
